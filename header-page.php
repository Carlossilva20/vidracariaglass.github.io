    ...
    <div class="topbar clearfix">
        <div class="container">
            <ul class="topbar-left">
                <li class="phoneNo"><i class="fa fa-phone"></i>(71)9 8540-2815</li>
                <li class="email-id hidden-xs hidden-sm"><i class="fa fa-envelope"></i>
                    <a href="mailto:info@yourdomain.com">palmasglass2.0@gmail.com</a>
                </li>
            </ul>
                        ...
                        <div class="header_inner">
                            ...
                            <div class="collapse navbar-collapse" id="main-nav">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li class="apply_now"><a href="buying-steps.html">Entrar</a></li>
                                </ul>
                            </div><!-- navbar-collapse -->
